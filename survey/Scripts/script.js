...
function getQuestion()
{
    ...
    try {
        ...
        questions[1] = ["DEU 1", "Would you order a homecooked meal or cook it for somebody else, why?"];
        ...
        questions[6] = ["DEU 6", "Would you fill out a survey if it would look nice, easy to answer and more entertaining, why? "];
